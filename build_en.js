...
const dictionary = {
  ...
  '핸드프레스 e.max 베니어. 심미 전문 기공사 담당. 3D 왁스업 무료 제공.': 'Hand-pressed e.max veneers handled by esthetic specialists. Free 3D wax-up provided.',
  '디자인': 'Design',
  '크라운 디자인': 'Crown Design',
  'exocad, 3Shape 기반의 정밀 크라운 디자인. 원장님 선호 스타일 반영 및 디자인 파일(STL) 신속 전송.': 'Precision crown design based on exocad and 3Shape. Reflection of doctor\'s preferred style and fast transmission of design files (STL).',
  '교정': 'Ortho',
