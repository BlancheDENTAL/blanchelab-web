...
const dictionary = {
  ...
  'Try One Case Free하기': 'Claim Free Case',
  '리메이크율': 'Remake Rate',
  '납기 (배송 포함)': 'Turnaround (inc. shipping)',
  '20만원': '$150',
  '현재 제작 중인 케이스': 'Cases in Production',
  '김** 원장님 · #16 임플란트 크라운': 'Dr. Kim · #16 Implant Crown',
  '지르코니아 · 커스텀 어버트먼트': 'Zirconia · Custom Abutment',
  '밀링 중': 'Milling',
  '박** 원장님 · 베니어 ×6': 'Dr. Park · Veneer ×6',
  'e.max · 전치부 심미': 'e.max · Anterior Esthetic',
  'QC 검수': 'QC',
  ...
  '개의 Implant Crown': 'Implant Crowns',
  '제작 ~ 배송 완료': 'Fabrication to Delivery',
  'Services표': 'Services',
  '가장 많이 찾으시는': 'Most Popular',
  '/ 유닛': '/ unit',
  '≈ $150 USD · 어버트먼트 포함': '≈ $150 USD · Abutment included',
  '보철': 'Prosthetics',
  '단관 크라운 & 브릿지': 'Single Crown & Bridge',
  '/ 유닛~': '/ unit~',
  '≈ $70 USD~': '≈ $70 USD~',
  '풀아치': 'Full Arch',
  '/ 아치~': '/ arch~',
  '≈ $1,800 USD~': '≈ $1,800 USD~',
  '심미': 'Esthetic',
  '베니어 & 스마일 디자인': 'Veneers & Smile Design',
  '≈ $135 USD~': '≈ $135 USD~',
  '교정': 'Ortho',
  '투명교정 장치': 'Clear Aligners',
  '≈ $285 USD~': '≈ $285 USD~',
  '의치': 'Dentures',
  '디지털 덴쳐': 'Digital Dentures',
  '≈ $165 USD~': '≈ $165 USD~',
  '스플린트': 'Splint',
  '나이트가드 & 스플린트': 'Nightguard & Splints',
  '≈ $45 USD~': '≈ $45 USD~',
